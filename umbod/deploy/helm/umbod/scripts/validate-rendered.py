...
def validate_core(core: str) -> None:
    ...
    require(core.count("name: metrics-api\n              containerPort: 8001") == 1, "API must declare a uniquely named metrics port")
    require(core.count("name: metrics-mcp\n              containerPort: 8012") == 1, "MCP must declare a uniquely named metrics port")
